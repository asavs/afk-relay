...
nonisolated enum MovementCostPolicy {
    static func reserve(distance: Double, state: EconomyState, balance: MVPBalance = .v2) -> MovementReservation {
    ...
    @discardableResult static func commit(distance: Double, state: inout EconomyState, balance: MVPBalance = .v2) -> Double {
